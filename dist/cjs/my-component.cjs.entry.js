...
const index = require('./index-ae37ce2c.js');
...
const MyComponent = class {
    ...
    render() {
        return (index.h("div", { key: '6e3a9fc77611c9627113656114d262c12c8f4fcf', class: css({ color: 'red', padding: '1rem' }) }, "Hello, World! I'm ", this.getText(), index.h("button", { key: '59a296c036beb0f4846db7288773f8bb761abd1a', class: button({ visual: 'solid' }), onClick: () => console.log('HIT!') }, "lalalal")));
    }
};
